...
export declare function getOperation(route: IRoute): oa.OperationObject;
export declare function getOperationId(route: IRoute): string;
export declare function getPaths(routes: IRoute[]): oa.PathObject;
...
export declare function getQueryParams(route: IRoute): oa.ParameterObject[];
...
export declare function getSpec(routes: IRoute[]): oa.OpenAPIObject;
